...
CHECKPOINTS: dict[str, dict[str, str]] = {
    ...
    "ltx-2.3-22b-ic-lora-colorization-0.9": {
        ...
        "size": "adapter",
        "description": "LTX-2.3 IC-LoRA colorization adapter",
        "type": "lora",
    ...
    "ltx-2.3-22b-ic-lora-decompression-0.9": {
        ...
        "size": "adapter",
        "description": "LTX-2.3 IC-LoRA decompression/restoration adapter",
        "type": "lora",
    ...
    "ltx-2.3-22b-ic-lora-deblur-0.9": {
        ...
        "size": "adapter",
        "description": "LTX-2.3 IC-LoRA deblur adapter",
        "type": "lora",
    ...
    "ltx-2.3-22b-ic-lora-in-outpainting-0.9": {
        ...
        "size": "adapter",
        "description": "LTX-2.3 IC-LoRA inpainting/outpainting adapter",
        "type": "lora",
